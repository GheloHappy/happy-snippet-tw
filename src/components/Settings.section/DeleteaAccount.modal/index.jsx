const DeleteAccount = ({setIsDelete}) => {
    ...
    return (
        <div className="w-full h-screen absolute top-0 bg-white bg-opacity-5 backdrop-filter backdrop-blur-sm p-2 md:p-10 rounded flex flex-col items-center justify-center">
            <div className="bg-gray-100 mx-3 md:mx-0 md:w-1/2 rounded p-5">
                ...
                <div className="w-full flex items-center justify-center p-1 my-2 gap-5">
                    <label className="font-semibold text-[1.2rem]">Input your password: </label>
                    <input type="password" className="p-2 w-1/2 rounded text-[1.2rem]" placeholder="Your Password"/>
                </div>
